...
# 2. Write clean HTML template file
...
<body>
    ...
    <script>
        ...
        /* 100% BULLET-PROOF INSTANT DIRECT LOGIN */
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', renderColleagues);
        } else {
            renderColleagues();
        }
    </script>
...
print("✔ Clean index.html and web_portal.py generated!")
