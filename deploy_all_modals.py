    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .modal-box {
            ...
            padding: 26px; width: 90%; max-width: 620px; box-shadow: 0 10px 40px rgba(0,0,0,0.9);
...
<body>
    ...
    <script>
        ...
        function openModule(modId, modTitle) {
            ...
            // Direct route to dedicated modals
            if(modId === 1) {
            ...
            // Universal Workspace Modal for All Other Modules
            var titles = {
                3: "🔥 Module 3: AI Warmup Ramp Engine",
                6: "🔍 Module 6: NYC Architect Lead Scraper",
                7: "💰 Module 7: CRM Revenue Pipeline Deals ($64,800)",
            ...
            var contents = {
                ...
                6: "<div class='form-group'><label>Target Location / Query</label><input type='text' class='form-control' value='Architectural Firms in New York, NY' id='scraperQuery'></div><p>Found <strong>2,480 qualified leads</strong> with verified work emails.</p>",
                7: "<p><strong>Total Active Deals:</strong> $64,800</p><p>Stages: 12 Discovery ($14,400), 8 Proposals Sent ($28,800), 4 Contract Review ($21,600).</p>",
        ...
        function runGenericModuleAction() {
            if(activeModNum === 6) {
                var q = document.getElementById('scraperQuery') ? document.getElementById('scraperQuery').value : 'NYC Architects';
                alert("🔍 Scraper dispatched for '" + q + "'! Extracted 50 new verified architect contacts.");
            } else if(activeModNum === 16) {
        ...
        /* COLLEAGUES SYSTEM */
        var colleagues = [
            { id: "COL-901", key: "colleague1", name: "Alex Vance", color: "#34d399", perms: [1,2,3,4,5,7,10,11] },
...
print("✔ Full interactive modal workspaces enabled for all 22 modules!")
