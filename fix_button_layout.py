...
code_content = r'''"""
GRACE OUTREACH ASSISTANT - ENTERPRISE AI CINEMATIC WORLD & COMMAND CENTER
Single-file self-contained production application for Cloud, Railway, Docker, and Local execution.
...
<head>
    ...
    <title>Grace Outreach Assistant | Enterprise AI World & Command Center</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .module-capsule.bursting {
            animation: burstEffect 0.35s cubic-bezier(0.1, 0.9, 0.2, 1) forwards !important;
        }
        ...
        /* AMBIENT CONTROLS (ONLY VISIBLE ON LOGIN SCREEN) */
        .ambient-controls-login {
            position: absolute;
            top: 24px;
            right: 30px;
            z-index: 99;
...
<body>
    ...
    <!-- LOGIN SCREEN -->
    <div id="authViewport">
        <!-- AMBIENT AUDIO & THEME ICONS PLACED CLEANLY ON LOGIN ONLY -->
        <div class="ambient-controls-login">
            <button class="glass-icon-btn" id="audioToggle" onclick="toggleAudioPlayback()" title="Toggle Ambience Audio"><i id="loginAudioIcon" class="fas fa-volume-mute"></i></button>
            <button class="glass-icon-btn" onclick="toggleThemeMode()" title="Toggle Dark/Light Mode"><i id="themeIconLogin" class="fas fa-sun"></i></button>
        </div>
    ...
    <!-- ENTERPRISE DASHBOARD (NO FLOATING BUTTON OVERLAP) -->
    ...
    <script>
        ...
        function toggleAudioPlayback() {
            ...
            const loginIcon = document.getElementById('loginAudioIcon');
            ...
            if(!isAudioPlaying) {
                ...
                if(loginIcon) loginIcon.className = 'fas fa-volume-up';
            } else {
                ...
                if(loginIcon) loginIcon.className = 'fas fa-volume-mute';
            }
        }
        ...
        function toggleThemeMode() {
            ...
            const iconL = document.getElementById('themeIconLogin');
            if(iconL) iconL.className = next === 'dark' ? 'fas fa-sun' : 'fas fa-moon';
...
print("✔ Button positions cleanly fixed and organized!")
