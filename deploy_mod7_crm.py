...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .kanban-col {
            background: rgba(3, 10, 12, 0.7); border: 1px solid var(--border-color);
            border-radius: 12px; padding: 12px; min-height: 280px; display: flex; flex-direction: column;
        }
        .kanban-col-head {
        ...
        .deal-item {
            ...
            border-radius: 8px; padding: 10px; margin-bottom: 8px; cursor: pointer; transition: 0.2s;
        }
...
<body>
            ...
            <section id="tab-matrix" class="tab-section">
                <div class="panel-card">
                    ...
                    <div class="modules-matrix-grid" id="matrixContainer">
                        ...
                        <div class="module-matrix-card" id="mod-7" onclick="openModule(7, 'CRM Revenue Pipeline')"><div class="matrix-icon"><i class="fas fa-dollar-sign"></i></div><div><div style="font-weight:800; font-size:14px;">7. CRM Revenue Pipeline</div><div style="font-size:11.5px; color:var(--text-muted);"><span id="matrixDealVal">&#36;64,800</span> Active deal monitor</div></div></div>
    ...
    <!-- MODULE 7: CRM REVENUE PIPELINE MODAL (INTERACTIVE KANBAN + AUTO-SUM + CELEBRATION) -->
    <div id="crmModal" class="modal-overlay">
        <div class="modal-box" style="max-width: 860px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px;">
                <div>
                    <span style="font-size: 18px; font-weight: 900; color: #fbbf24;">💰 Module 7: CRM Revenue Pipeline & Visual Kanban</span>
            ...
            <div class="kanban-grid">
                ...
                <div class="kanban-col">
                    <div class="kanban-col-head">
                        <span style="color: #38bdf8;">1. Discovery</span>
                ...
                <div class="kanban-col">
                    <div class="kanban-col-head">
                        <span style="color: #fbbf24;">2. Proposal Sent</span>
                ...
                <div class="kanban-col">
                    <div class="kanban-col-head">
                        <span style="color: #a78bfa;">3. Contract Review</span>
                ...
                <!-- COL 4: CLOSED WON -->
                <div class="kanban-col" style="border-color: rgba(16, 185, 129, 0.4); background: rgba(5, 150, 105, 0.08);">
                    <div class="kanban-col-head">
                        <span style="color: #34d399;">4. Closed Won 🎉</span>
    ...
    <script>
        ...
        /* MODULE 7: CRM REVENUE PIPELINE & KANBAN ENGINE */
        var crmDeals = [
                ...
                if(targetBox) {
                    ...
                    card.innerHTML = 
                        ...
                        '<div style="display:flex; justify-content:space-between; align-items:center; margin-top:6px;">' +
                            ...
                            '<button onclick="advanceDeal(' + d.id + ')" style="background:transparent; border:1px solid #10b981; color:#34d399; font-size:10px; padding:2px 6px; border-radius:4px; cursor:pointer;">Move &rarr;</button>' +
                        '</div>';
        ...
        function advanceDeal(dealId) {
            ...
            if(d.stage === 'discovery') d.stage = 'proposal';
                ...
                alert("Deal already WON! Transferred to closed accounts.");
                return;
            }
        ...
        /* COLLEAGUES SYSTEM */
        var colleagues = [
            { id: "COL-901", key: "colleague1", name: "Alex Vance", color: "#34d399", perms: [1,2,3,4,5,6,7,10,11] },
...
print("✔ Module 7 upgraded with Interactive Kanban, Dynamic Auto-Sum & Closed-Won Celebrations!")
