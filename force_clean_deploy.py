...
# Random build stamp to bust Railway Docker cache completely
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .dashboard-body { padding: 28px 24px; max-width: 1400px; margin: 0 auto; }
        ...
        .panel-header { font-size: 16px; font-weight: 800; margin-bottom: 16px; display: flex; justify-content: space-between; }
        ...
        /* HARD SUPPRESS ANY FLOATING ICONS */
...
<body>
    ...
    <header class="top-navbar">
        ...
        <div class="nav-actions">
            <button class="btn-broadcast" onclick="alert('Broadcast modal ready!')"><i class="fas fa-bullhorn"></i> Broadcast Alert</button>
    ...
    <main class="dashboard-body">
        ...
        <section id="tab-custom" class="tab-section">
            <div class="panel-card">
                ...
                <p style="color:var(--text-muted); font-size:14px;">Preset ambient audio & video sound extractor controls.</p>
            </div>
        </section>
    </main>
...
if __name__ == "__main__":
    ...
    print(f"✔ Server online on http://{{HOST}}:{{PORT}} (Build: {build_stamp})")
    server.serve_forever()
'''

with open("web_portal.py", "w", encoding="utf-8", newline='\n') as f:
    f.write(f"html_content = '''{html_content}'''\n" + server_code)

print("✔ Overwrite complete. Ready to deploy!")
