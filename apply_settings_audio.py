...
<body>
    ...
    <!-- HIDDEN AUDIO ELEMENT FOR EXTRACTED / UPLOADED SOUNDS -->
    ...
    <div id="enterpriseApp">
        <header class="top-navbar">
            ...
            <div class="nav-actions">
                ...
                <button class="btn-luxury" style="width: auto; padding: 8px 14px; background: #dc2626; border:none;" onclick="triggerSignOut()" title="Secure Logout"><i class="fas fa-power-off"></i></button>
            </div>
        </header>
    ...
    <script>
        ...
        /* =========================================================
           ADVANCED AUDIO STUDIO & VIDEO SOUND EXTRACTOR
           ========================================================= */
        let audioCtx = null;
        ...
        function selectPresetAudio(presetName, el) {
            ...
            // If custom audio was playing, pause it and play synth preset
            if(!player.paused) {
                player.pause();
            }
            if(isAudioPlaying) {
        ...
        function toggleAudioPlayback() {
            ...
            if(!isAudioPlaying) {
                // If custom audio source exists, play custom file; else synth
        ...
        function handleMediaUpload(e) {
            ...
            if(file) {
                ...
                player.play();
                isAudioPlaying = true;
                document.getElementById('audioBtnIcon').className = 'fas fa-pause';
                document.getElementById('audioBtnText').innerText = 'Playing: ' + file.name.substring(0, 15) + '...';
                alert('✔ Media extracted & playing: ' + file.name);
            }
        }
...
print("✔ Settings & Audio Studio Successfully Integrated in web_portal.py!")
