    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .modal-box {
            ...
            padding: 26px; width: 90%; max-width: 580px; box-shadow: 0 10px 40px rgba(0,0,0,0.9);
...
<body>
            ...
            <section id="tab-matrix" class="tab-section">
                <div class="panel-card">
                    ...
                    <div class="modules-matrix-grid" id="matrixContainer">
                        ...
                        <div class="module-matrix-card" id="mod-2" onclick="openAddGmailModal()"><div class="matrix-icon"><i class="fas fa-envelope"></i></div><div><div style="font-weight:800; font-size:14px;">2. Gmail Multi-Tenant Hub</div><div style="font-size:11.5px; color:var(--text-muted);">OAuth & 3-Tier Categorization</div></div></div>
                        ...
                        <div class="module-matrix-card" id="mod-4" onclick="openCampaignStudioModal()"><div class="matrix-icon"><i class="fas fa-paper-plane"></i></div><div><div style="font-weight:800; font-size:14px;">4. Campaign Studio (AI Enhanced)</div><div style="font-size:11.5px; color:var(--text-muted);">A/B Split + AI Scorer + Timezone</div></div></div>
    ...
    <div id="gmailModal" class="modal-overlay">
        <div class="modal-box">
            <div style="font-size: 17px; font-weight: 900; color: #fbbf24; margin-bottom: 14px; display:flex; justify-content:space-between;">
                ...
                <i class="fas fa-times" style="cursor:pointer;" onclick="closeAddGmailModal()"></i>
            </div>
            ...
            <div style="display: flex; gap: 10px; margin-top: 18px;">
                ...
                <button type="button" class="btn-luxury" style="background: #374151; border-color:#4b5563;" onclick="closeAddGmailModal()">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <div id="campaignStudioModal" class="modal-overlay">
        <div class="modal-box">
            <div style="font-size: 17px; font-weight: 900; color: #fbbf24; margin-bottom: 14px; display:flex; justify-content:space-between;">
                ...
                <i class="fas fa-times" style="cursor:pointer;" onclick="closeCampaignStudioModal()"></i>
            </div>
            ...
            <!-- FEATURE 3: TIME-ZONE SMART DELIVERY -->
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" class="btn-luxury" style="background: #374151; border-color:#4b5563;" onclick="closeCampaignStudioModal()">Close</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function closeAddGmailModal() { document.getElementById('gmailModal').style.display = 'none'; }
        ...
        function openCampaignStudioModal() {
            document.getElementById('campaignStudioModal').style.display = 'flex';
            evaluateSpamScore();
        }
        function closeCampaignStudioModal() {
            document.getElementById('campaignStudioModal').style.display = 'none';
        }
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', function() { renderColleagues(); renderInboxes(); });
        } else {
            renderColleagues();
            renderInboxes();
        }
...
print("✔ Module 4 updated with A/B Testing, AI Spam Scorer and Timezone Delivery!")
