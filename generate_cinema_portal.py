...
<body>
    ...
    <div class="ambient-controls">
        <button class="glass-icon-btn" id="audioToggle" onclick="toggleAudio()" title="Toggle Ambience Audio"><i class="fas fa-volume-mute"></i></button>
        <button class="glass-icon-btn" onclick="toggleThemeMode()" title="Toggle Dark/Light Mode"><i id="themeIcon" class="fas fa-sun"></i></button>
    </div>
    ...
    <div id="enterpriseApp">
        <header class="top-navbar">
            ...
            <div class="nav-actions">
                ...
                <button class="glass-icon-btn" onclick="triggerSignOut()" title="Secure Logout" style="background:#dc2626; color:#fff; border:none;"><i class="fas fa-power-off"></i></button>
            </div>
        </header>
        ...
        <nav class="nav-ribbon-bar" id="ribbonContainer">
            ...
            <button id="ribbon-tab-custom" class="ribbon-btn" onclick="switchTab('tab-custom', this)"><i class="fas fa-palette"></i> Personalization</button>
        </nav>
        ...
        <main class="dashboard-body">
            ...
            <section id="tab-custom" class="tab-section">
                <div class="panel-card">
                    <div class="panel-header"><span>🎨 Theme & Accent Customization</span></div>
...
print("✔ Ultra-Luxury Cinematic AI World successfully generated in web_portal.py!")
