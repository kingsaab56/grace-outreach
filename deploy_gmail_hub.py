...
# Clean HTML with Full Gmail Multi-Tenant Hub (OAuth + App Password + 3 Sections)
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .modal-box {
            ...
            padding: 26px; width: 90%; max-width: 480px; box-shadow: 0 10px 40px rgba(0,0,0,0.9);
        }
    </style>
</head>
<body>
    ...
    <div id="enterpriseApp">
        ...
        <main class="dashboard-body">
            ...
            <section id="tab-dash" class="tab-section active">
                ...
                <!-- GMAIL MULTI-TENANT HUB EXPANDED PREVIEW -->
    ...
    <!-- GMAIL ADD MODAL (OAUTH & APP PASSWORD) -->
    <div id="gmailModal">
        <div class="modal-box">
    ...
    <script>
        /* GMAIL ACCOUNTS STORE (3 CATEGORIES) */
        var inboxes = [
        ...
        function submitNewGmail() {
            ...
            if(authMethod === 'password' && !pass) {
                alert("Please enter the 16-digit App Password.");
                return;
            }
            ...
            if(low.includes("grace") || low.includes("outreach.org")) {
                cat = "business";
            } else if(low.includes("shani") || low.includes("work") || low.includes("malik")) {
                cat = "workplace";
            }

            if(authMethod === 'oauth') {
                // Open simulated/real Google OAuth popup tab
                var oauthWin = window.open('https://accounts.google.com/o/oauth2/v2/auth?client_id=grace_cloud&response_type=token&scope=https://mail.google.com/&redirect_uri=' + encodeURIComponent(window.location.origin), '_blank', 'width=520,height=620');
...
print("✔ Generated Module 2 Gmail Hub with Dual Auth and 3-Tier Categorization!")
